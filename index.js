...
function logCode() {
  ...
  console.log("http://localhost:5000/20110356");
  
  console.log("Lệnh POST Dùng Terminal:");
  console.log('curl -X POST -H "Content-Type: application/json" -d \'{"id":"19110142","name":"Nguyen Thanh Vy"}\' http://localhost:5000/MSSV/19110142');
  ...
  console.log("http://localhost:5000/message/20110356");
